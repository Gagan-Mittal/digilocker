...
contract DigitalLocker is WorkbenchBase('DigitalLocker', 'DigitalLocker')
{
    ...
    string constant LockerName='MNNIT DigitalLocker';
    enum StateType {AvailableToShare, SharingRequestPending, SharingWithThirdParty}
    address public contractOwner; //deployer(MNNIT)
    address[] public userAcc; //sudents of mnnit
    ...
    {
        contractOwner = msg.sender;  //MNNIT in our case
        ContractCreated();
    }
